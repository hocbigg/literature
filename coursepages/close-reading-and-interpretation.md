...
Each text should be read multiple times with different aims. The first reading is for basic comprehension. The second is for formal noticing: mark repetitions, unusual word choices, shifts in tone, line breaks, metaphors, narrative perspective, or patterns of imagery. The third reading is where interpretation begins: write short paragraphs explaining what these patterns seem to be doing.

When reading criticism from *Close Reading: The Reader*, do not treat the essays as authorities. Instead, reconstruct their arguments: identify what textual details they select and how those details are connected to claims about meaning. In your notes, rewrite one paragraph of an essay in your own words, preserving its logic but not its phrasing.

At least once a week, write a one-page close reading of a short passage—ten lines of poetry, a page of prose, or a short scene. Begin with quotation, move to analysis of specific language, and end with a provisional interpretive claim. These pieces are not essays; they are exercises in disciplined attention and inference.

## Managing difficulty

The main difficulty is the impulse to jump from reading to theme. When you catch yourself summarizing what a text is “about,” stop and return to the words on the page. Force every claim to be anchored in a quotation.

Another obstacle is ambiguity. Literary texts often support more than one interpretation, which can feel destabilizing. Instead of trying to decide which reading is “right,” compare how different readings explain the same details. The better reading is the one that accounts for more of the text with fewer distortions.

If an essay in *Close Reading* feels impenetrable, skip ahead to one that deals with a familiar poem or story, then come back. Understanding grows by triangulation: text, interpretation, and your own reading slowly align.
...
Used together, these materials create a loop of text, analysis, and reflection that gradually trains you to read with scholarly precision.